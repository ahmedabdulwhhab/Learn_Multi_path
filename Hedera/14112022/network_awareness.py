...
class NetworkAwareness(app_manager.RyuApp):
	...
	def _packet_in_handler(self, ev):
		...
		#print("inside network_awareness Line 131")
		...
		if arp_pkt:
			...
			print("line 138 ",datapath.id, in_port, arp_src_ip, mac)
			...
			print("line 146 ",datapath.id, in_port, ip_src_ip, mac)
		else:
			pass
	...
	def create_access_table(self, fanout):
		...
		num = 1
		k = 1
		for i in range(3001, int(3001+(fanout**2)/2)):
			for j in range(int(fanout/2)+1, int(fanout+1)):
